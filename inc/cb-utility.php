...
add_shortcode('social_fb_icon', function () {
    ...
    if ($social['facebook_url'] ?? null) {
        return '<a href="' . $social['facebook_url'] . '" target="_blank"><i class="fab fa-facebook"></i></a>';
    }
    return;
});
add_shortcode('social_ig_icon', function () {
    ...
    if ($social['instagram_url'] ?? null) {
        return '<a href="' . $social['instagram_url'] . '" target="_blank"><i class="fab fa-instagram"></i></a>';
    }
    return;
});
...
add_shortcode('social_pt_icon', function () {
    ...
    if ($social['pinterest_url'] ?? null) {
        return '<a href="' . $social['pinterest_url'] . '" target="_blank"><i class="fab fa-pinterest"></i></a>';
    }
    return;
});
add_shortcode('social_yt_icon', function () {
    ...
    if ($social['youtube_url'] ?? null) {
        return '<a href="' . $social['youtube_url'] . '" target="_blank"><i class="fab fa-youtube"></i></a>';
    }
    return;
});
add_shortcode('social_in_icon', function () {
    $social = get_field('social', 'option') ?? null;
    if ($social['linkedin_url'] ?? null) {
        return '<a href="' . $social['linkedin_url'] . '" target="_blank"><i class="fab fa-linkedin"></i></a>';
    }
    return;
});
add_shortcode('social_gp_icon', function () {
    $social = get_field('social', 'option');
    if ($social['google_url'] ?? null) {
        return '<a href="' . $social['google_url'] . '" target="_blank"><i class="fas fa-globe-americas"></i></a>';
    }
    return;
});
